// ============================================================================
// Hardware Source: src/app/api/webhooks/stripe/route.ts
// Route: /api/webhooks/stripe
// Version: 1.0.0 — 2026-04-08
// Why: Webhook receiver for Stripe payment events that syncs billing and booking state.
...
// Critical Path: Billing state synchronization for payment confirmation, failure, and refund events.
// Primary Dependencies: Stripe signature verification, booking/payment records, cache revalidation.
// Risk Notes: Duplicate webhook delivery must not double-apply state transitions.
// ============================================================================
