// ============================================================================
// Hardware Source: src/app/claim/[license_number]/page.tsx
// Route: /claim/[license_number]
// Version: 1.0.0 — 2026-04-08
// Why: Claim verification route connecting registry identity signals to consultant ownership flows.
// Domain: Identity Claim & Verification
// Env / Identity: React Server Component
// Owner: Verixa Web
// Notes: Keep route behavior deterministic and aligned with metadata, SEO, and access expectations.
// Critical Path: Identity ownership flow; links public registry identity to account ownership state.
// Risk Notes: Handle hinting/verification data carefully to avoid account takeover vectors.
// ============================================================================
...
export async function generateMetadata({
  ...
  const data = await getConsultantByLicense(license_number);
  return {
