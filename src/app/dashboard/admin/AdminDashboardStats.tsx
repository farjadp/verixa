...
export default function AdminDashboardStats({ 
  ...
  const stats = [
    { title: "Total Clients", value: (clients ?? 0).toLocaleString(), icon: Users, trend: "+12%", color: "text-blue-400", bg: "bg-blue-400/10", border: "border-blue-400/20" },
    { title: "Registered Consultants", value: (consultants ?? 0).toLocaleString(), icon: Briefcase, trend: "+5%", color: "text-[#2FA4A9]", bg: "bg-[#2FA4A9]/10", border: "border-[#2FA4A9]/20" },
    { title: "Platform Bookings", value: (bookings ?? 0).toLocaleString(), icon: CalendarDays, trend: "+24%", color: "text-purple-400", bg: "bg-purple-400/10", border: "border-purple-400/20" },
    { title: "Gross Platform Rev", value: `$${(revenue ?? 0).toLocaleString()}`, icon: DollarSign, trend: "+18%", color: "text-green-400", bg: "bg-green-400/10", border: "border-green-400/20" },
  ];
