    ...
    <div className="bg-[#0F2A44] border border-gray-800 rounded-3xl p-6 shadow-2xl relative overflow-hidden group hover:border-gray-700 transition-all">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 relative z-10">
        ...
        <div className="bg-gray-900/50 p-4 rounded-2xl border border-gray-800 flex flex-col items-center justify-center text-center">
          <p className="text-3xl font-black text-white font-serif">{(stats.total ?? 0).toLocaleString()}</p>
        ...
        <div className="bg-green-900/10 p-4 rounded-2xl border border-green-900/30 flex flex-col items-center justify-center text-center">
          <div className="flex items-center gap-1.5 justify-center mb-1">
            ...
            <p className="text-3xl font-black text-green-400 font-serif">{(stats.active ?? 0).toLocaleString()}</p>
          </div>
        ...
        <div className="bg-blue-900/10 p-4 rounded-2xl border border-blue-900/30 flex flex-col items-center justify-center text-center">
          <div className="flex items-center gap-1.5 justify-center mb-1">
            ...
            <p className="text-3xl font-black text-blue-400 font-serif">{(stats.withEmail ?? 0).toLocaleString()}</p>
          </div>
        ...
        <div className="bg-purple-900/10 p-4 rounded-2xl border border-purple-900/30 flex flex-col items-center justify-center text-center">
          <div className="flex items-center gap-1.5 justify-center mb-1">
            ...
            <p className="text-3xl font-black text-purple-400 font-serif">{(stats.withPhone ?? 0).toLocaleString()}</p>
          </div>
