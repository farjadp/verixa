  ...
  return (
    <div className="w-full flex flex-col xl:flex-row gap-6">
      ...
      <div className="xl:w-1/3 flex flex-col gap-6">
         <div className="bg-white border border-[#e5e7eb] p-5 rounded-2xl flex flex-col min-h-[600px] shadow-sm">
               ...
               {posts.map(post => {
                  ...
                  return (
                    <button 
                       ...
                       className={`w-full text-left p-4 rounded-xl border transition-all ${selectedPostId === post.id ? "bg-[#ffffff] border-[#2FA4A9] shadow-sm" : "bg-white border-[#e5e7eb] hover:bg-gray-50"}`}
                    >
                       <h4 className={`text-sm font-bold line-clamp-2 ${selectedPostId === post.id ? "text-[#2FA4A9]" : "text-gray-900"}`}>{post.title}</h4>
      ...
      <div className="xl:w-2/3 flex flex-col gap-6">
         ...
         {!selectedPost ? (
            ...
            <div className="bg-white border border-[#e5e7eb] rounded-2xl overflow-hidden shadow-sm flex flex-col h-full min-h-[700px]">
               
               {/* Header Panel */}
               <div className="bg-[#ffffff] border-b border-[#e5e7eb] p-6 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                  <div>
                  ...
                  {!socialJob && (
                     <button onClick={() => handleIgniteEngine(selectedPost.id)} disabled={loading} className="bg-[#0F2A44] hover:bg-black text-white px-5 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 transition-colors disabled:opacity-50 shrink-0 shadow-lg">
                     ...
                     <div className="flex flex-col gap-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 scale-95 origin-top">
                           <div className="bg-white border border-[#e5e7eb] p-5 rounded-xl shadow-sm">
                              <h4 className="text-[11px] font-black uppercase tracking-widest text-[#2FA4A9] mb-3 border-b border-[#e5e7eb] pb-2">Psychological Hooks (5)</h4>
                           ...
                           <div className="bg-white border border-[#e5e7eb] p-5 rounded-xl shadow-sm">
                              <h4 className="text-[11px] font-black uppercase tracking-widest text-blue-500 mb-3 border-b border-[#e5e7eb] pb-2">Call-to-Action Variations (3)</h4>
                              <ul className="list-decimal list-inside space-y-2 text-[11px] text-gray-600 font-medium">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                           ...
                           <div className="bg-white border border-[#e5e7eb] rounded-xl overflow-hidden shadow-sm">
                              <div className="bg-blue-50/50 p-3 flex items-center gap-2 border-b border-[#e5e7eb]">
                              ...
                              <textarea 
                                 rows={8}
                                 className="w-full p-4 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#2FA4A9]/20 border-0 resize-y"
                           ...
                           <div className="bg-white border border-[#e5e7eb] rounded-xl overflow-hidden shadow-sm">
                              <div className="bg-gray-50 p-3 flex items-center gap-2 border-b border-[#e5e7eb]">
                           ...
                           <div className="bg-white border border-[#e5e7eb] rounded-xl overflow-hidden shadow-sm">
                              <div className="bg-blue-400/5 p-3 flex items-center gap-2 border-b border-[#e5e7eb]">
