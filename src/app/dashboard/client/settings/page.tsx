...
export default async function ClientSettingsPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-serif font-bold text-[#1A1A1A]">Account & Preferences</h1>
      ...
      <div className="grid grid-cols-1 gap-10">
        ...
        {/* Profile Details */}
        <section className="bg-white rounded-[32px] border border-[#f5ecd8] p-8 shadow-sm">
           <div className="mb-6">
             <h2 className="text-xl font-bold font-serif text-[#1A1A1A]">Personal Information</h2>
        ...
        {hasPassword && (
          <section className="bg-white rounded-[32px] border border-[#f5ecd8] p-8 shadow-sm">
             <div className="mb-6">
               <h2 className="text-xl font-bold font-serif text-[#1A1A1A]">Security & Password</h2>
