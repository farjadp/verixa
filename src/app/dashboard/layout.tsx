...
// Route: /dashboard/* (authenticated shell)
// Version: 1.0.0 — 2026-04-08
// Why: Authenticated workspace shell that enforces session checks and renders persistent dashboard navigation.
// Domain: Authenticated Workspace
// Env / Identity: React Server Component
// Owner: Verixa Web
// Notes: Session gating is mandatory; never render privileged workspace content without server-side authorization.
// Critical Path: Authenticated workspace entry point for consultants and admins.
// Primary Dependencies: Session resolution, role checks, sidebar navigation, unread notification counts.
// Failure Strategy: Redirect unauthenticated users before any sensitive data fetch or render.
// ============================================================================
