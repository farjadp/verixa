    ...
    <main className="p-8 max-w-4xl mx-auto space-y-8">
      ...
      <form className="space-y-8 pb-16">
           ...
           <div className="space-y-6">
             ...
             <div>
               ...
               <div className="flex items-center gap-6">
                 ...
                 <div>
                   <button type="button" className="bg-[#ffffff] border border-[#e5e7eb] text-[#1A1F2B] text-sm font-bold px-4 py-2 rounded-lg hover:border-[#2FA4A9] transition-all">Upload Photo</button>
             ...
             {/* TAGLINE */}
             <div className="space-y-2">
               <label className="text-xs font-bold uppercase tracking-wider text-[#1A1F2B]">Headline / Tagline <span className="text-gray-400 font-normal lowercase tracking-normal ml-1">(Optional)</span></label>
               <input type="text" placeholder="e.g. Expert in Express Entry & Startup Visa" className="w-full bg-[#ffffff] border border-[#e5e7eb] px-4 py-3 rounded-xl text-[#1A1F2B] text-sm focus:border-[#2FA4A9]/50 focus:ring-4 focus:ring-[#2FA4A9]/10 outline-none transition-all" />
             </div>

             {/* BIO */}
             <div className="space-y-2">
               <label className="text-xs font-bold uppercase tracking-wider text-[#1A1F2B]">Professional Bio</label>
               <textarea rows={4} placeholder="Tell your clients about your experience, approach, and why they should choose you..." className="w-full bg-[#ffffff] border border-[#e5e7eb] px-4 py-3 rounded-xl text-[#1A1F2B] text-sm focus:border-[#2FA4A9]/50 focus:ring-4 focus:ring-[#2FA4A9]/10 outline-none transition-all resize-none"></textarea>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="space-y-2">
                 <label className="text-xs font-bold uppercase tracking-wider text-[#1A1F2B]">Public Phone Number</label>
                 <input type="tel" placeholder="+1 (555) 000-0000" className="w-full bg-[#ffffff] border border-[#e5e7eb] px-4 py-3 rounded-xl text-[#1A1F2B] text-sm focus:border-[#2FA4A9]/50 focus:ring-4 focus:ring-[#2FA4A9]/10 outline-none transition-all" />
               </div>
               <div className="space-y-2">
                 <label className="text-xs font-bold uppercase tracking-wider text-[#1A1F2B]">Website URL</label>
                 <input type="url" placeholder="https://..." className="w-full bg-[#ffffff] border border-[#e5e7eb] px-4 py-3 rounded-xl text-[#1A1F2B] text-sm focus:border-[#2FA4A9]/50 focus:ring-4 focus:ring-[#2FA4A9]/10 outline-none transition-all" />
               </div>
             </div>
             ...
             <div className="pt-6 mt-6 border-t border-[#e5e7eb]">
               <div className="flex items-center justify-between mb-4">
                 <h3 className="text-sm font-bold text-[#1A1F2B]">Social Media Links</h3>
                 <button type="button" className="text-xs font-bold text-[#2FA4A9] hover:bg-[#F5F7FA] px-3 py-1.5 rounded-lg transition-colors flex items-center border border-transparent hover:border-[#e5e7eb]">
                   + Add Profile
                 </button>
               </div>
               ...
               <div className="space-y-3">
                 ...
                 <div className="flex items-center gap-2 sm:gap-3">
                   <select className="bg-[#F5F7FA] border border-[#e5e7eb] text-[#1A1F2B] text-sm font-bold px-3 sm:px-4 py-3 rounded-xl focus:border-[#2FA4A9] outline-none max-w-[120px] sm:max-w-none">
                   ...
                   <input type="url" placeholder="https://..." defaultValue="linkedin.com/in/amirhossein" className="flex-1 bg-[#ffffff] border border-[#e5e7eb] px-3 sm:px-4 py-3 rounded-xl text-[#1A1F2B] text-sm focus:border-[#2FA4A9] outline-none transition-all" />
                 ...
                 <div className="flex items-center gap-2 sm:gap-3">
                   ...
                   <input type="url" placeholder="https://..." className="flex-1 bg-[#ffffff] border border-[#e5e7eb] px-3 sm:px-4 py-3 rounded-xl text-[#1A1F2B] text-sm focus:border-[#2FA4A9] outline-none transition-all" />
                   <button type="button" className="p-3 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all" aria-label="Remove">×</button>
                 </div>
               </div>
        ...
        <div className="bg-white rounded-3xl border border-[#e5e7eb] p-6 shadow-sm">
           ...
           <div className="space-y-6">
             <div className="space-y-2">
               <label className="text-xs font-bold uppercase tracking-wider text-[#1A1F2B]">Areas of Practice</label>
               <input type="text" placeholder="Type a service and press enter (e.g. Express Entry, Study Permits)" className="w-full bg-[#ffffff] border border-[#e5e7eb] px-4 py-3 rounded-xl text-[#1A1F2B] text-sm focus:border-[#2FA4A9]/50 focus:ring-4 focus:ring-[#2FA4A9]/10 outline-none transition-all" />
             ...
             <div className="space-y-2">
               ...
               <input type="text" placeholder="Type a language and press enter" className="w-full bg-[#ffffff] border border-[#e5e7eb] px-4 py-3 rounded-xl text-[#1A1F2B] text-sm focus:border-[#2FA4A9]/50 focus:ring-4 focus:ring-[#2FA4A9]/10 outline-none transition-all" />
               <div className="flex flex-wrap gap-2 mt-3 p-3 bg-gray-50 rounded-xl min-h-12 border border-dashed border-gray-200">
        ...
        <div className="bg-white rounded-3xl border border-[#e5e7eb] p-6 shadow-sm">
           <h2 className="text-lg font-bold text-[#1A1F2B] mb-2">Media Gallery</h2>
           ...
           <div className="w-full bg-gray-50 border-2 border-dashed border-gray-200 rounded-2xl p-8 flex flex-col items-center justify-center text-center hover:border-gray-300 transition-colors cursor-pointer group">
             <UploadCloud className="w-8 h-8 text-gray-400 mb-3 group-hover:text-[#2FA4A9] transition-colors" />
             <p className="text-sm font-bold text-[#1A1F2B] mb-1">Click to upload or drag & drop</p>
        ...
        <div className="flex justify-end sticky bottom-6 z-20">
          <button type="button" className="bg-[#0F2A44] text-white px-8 py-3.5 rounded-xl font-bold shadow-xl shadow-black/10 hover:bg-black transition-all flex items-center gap-2">
