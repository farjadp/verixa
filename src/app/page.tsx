    ...
    <main className="min-h-screen bg-[#ffffff] text-[#1A1F2B] font-serif">
      ...
      <section className="max-w-7xl mx-auto px-8 pt-20 pb-32 grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-10">
          <div className="flex items-center gap-3 text-sm font-bold text-[#2FA4A9] uppercase tracking-widest">
            <div className="w-12 h-[1px] bg-[#2FA4A9]" />
            CICC Licensed Only
          </div>
          ...
          <div className="flex flex-col gap-4 pt-8 font-sans max-w-2xl">
            <div className="relative group shadow-sm hover:shadow-xl transition-all rounded-full">
              <div className="absolute inset-y-0 left-6 flex items-center pointer-events-none">
                <Search className="w-5 h-5 text-gray-400 group-focus-within:text-[#2FA4A9] transition-colors" />
              </div>
              <input 
                type="text" 
                placeholder="Search by name, license number, or city..." 
                className="w-full bg-white border border-gray-200 py-6 pl-16 pr-32 rounded-full text-lg focus:border-[#2FA4A9] outline-none transition-all"
              />
              <button className="absolute right-3 top-1/2 -translate-y-1/2 bg-[#0F2A44] text-white px-8 py-3.5 rounded-full font-bold hover:bg-gray-800 transition">
                Search
              </button>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-2 px-6 text-sm">
              ...
              <div className="flex items-center gap-2 text-[#2FA4A9] font-semibold bg-[#F5F7FA] px-4 py-1.5 rounded-full w-fit">
        ...
        <div className="relative">
          <div className="absolute -inset-10 bg-[#2FA4A9]/5 blur-3xl rounded-full" />
          <div className="relative bg-white border border-gray-100 p-10 rounded-[40px] shadow-[0_30px_100px_-20px_rgba(0,0,0,0.05)] space-y-8 font-sans">
             <div className="flex justify-between items-start">
               ...
               <div className="flex items-center gap-1 text-[#2FA4A9]">
             ...
             <div className="flex justify-start">
               <div className="flex items-center gap-1.5 mb-1 bg-[#F5F7FA] text-[#2FA4A9] text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-full border border-[#e5e7eb]">
      ...
      <section className="w-full bg-[#F5F7FA] py-16 font-sans border-y border-gray-100 overflow-hidden">
        <div className="max-w-7xl mx-auto px-8">
          <div className="flex items-center justify-between mb-10">
            <h3 className="text-xl font-bold tracking-tight uppercase text-gray-500">Top Rated This Week</h3>
            <Link href="/search?sort=rating" className="text-sm font-bold border-b-2 border-[#0F2A44] pb-0.5 hover:text-[#2FA4A9] hover:border-[#2FA4A9] transition-colors">See All Top Rated</Link>
          </div>
               ...
               <Link href={`/consultant/${rcic.License_Number}`} key={rcic.License_Number} className="min-w-[300px] bg-white p-6 rounded-[32px] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer snap-start flex flex-col justify-between border border-gray-50 group">
                  <div className="flex justify-between items-start mb-6">
                    <div className="w-14 h-14 bg-gray-100 rounded-2xl flex items-center justify-center">
                      <User className="w-7 h-7 text-gray-400 group-hover:text-[#2FA4A9] transition-colors" />
                    </div>
                    <div className="flex items-center gap-1.5 bg-[#ffffff] border border-[#e5e7eb] px-3 py-1.5 rounded-xl text-[#2FA4A9]">
                      <Star className="w-3.5 h-3.5 fill-current" /> <span className="font-bold text-sm">Top</span>
                    </div>
                  </div>
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <h4 className="font-bold text-lg font-serif group-hover:text-[#2FA4A9] transition-colors line-clamp-1 pr-2">{rcic.Full_Name}</h4>
