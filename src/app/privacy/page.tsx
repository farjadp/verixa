      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        <div className="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 p-8 lg:p-14 text-gray-600 space-y-12">
          ...
          <div className="mt-16 text-center border-t border-gray-100 pt-16">
            <span className="inline-flex items-center justify-center p-4 bg-gray-50 rounded-full mb-4">
              <FileText className="w-6 h-6 text-gray-400" />
            </span>
            <h4 className="text-lg font-bold text-[#0F2A44]">End of Part 1</h4>
            <p className="text-sm text-gray-500 mt-2">Part 2 of the Data Protection Policy covering processing logic, storage, and 3rd-party compliance will be appended when available.</p>
          </div>
