  ...
  if (variant === "card") {
    return (
      <button 
        ...
        disabled={isLoading}
        className={`absolute top-4 right-4 shadow-sm border rounded-full p-2 transition-all ${isSaved ? 'bg-[#C29967] text-white border-[#C29967]' : 'bg-white text-gray-400 border-gray-100 hover:text-[#C29967]'}`}
  ...
  return (
    <button 
      ...
      className={`w-full md:w-auto px-6 py-3.5 rounded-xl font-bold transition-all flex items-center justify-center gap-2 border shadow-sm ${
        isSaved 
          ? "bg-[#C29967] text-white border-[#C29967] hover:bg-[#b0895c]" 
          : "bg-white text-gray-700 border-gray-200 hover:bg-gray-50 hover:border-[#C29967]/30"
      }`}
    >
